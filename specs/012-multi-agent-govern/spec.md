...
- [x] AC1: A single `ductus/ductus.md` file replaces both `ductus/ductus.md` and `ductus/ductus-auggie.md` — only one ductus source exists in `ductus/`
...
- [x] AC7: For each selected agent, scaffolding produces: project commands at `{cli-config-dir}/commands/{project}/`, the agent's setup source written as `setup.md`, an empty session JSON, a settings file in the agent's native format, and a copy of `ductus.md` at `{cli-config-dir}/commands/ductus.md`
