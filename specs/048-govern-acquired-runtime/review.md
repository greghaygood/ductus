...
reviewed-at: 2026-09-14T23:10:28Z
...
This spec's own `review.md` enters its review scope once this record is committed; it is named here and not counted in `examined`. Nothing reached `runtime/`, so no version bump and no tag are owed.
