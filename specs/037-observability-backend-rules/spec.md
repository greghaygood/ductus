...
next-criterion: 8
analyze:
  last-run: 2026-09-13T12:42:47Z
  analyzed-against: f2a6447f6963951faf14b5e6aafab01bd2a5e925
  hard-fail: 0
  blocking-findings: 0
  advisory: 0
  unexamined: 0
  analyzed-digest:
    plan.md: 50ae8cb13c1e2c02983672bd350e34638a3603379992adda8386ae1e44f0b81a
    review.md: 7811d455efb793908b7ae95dc1e594dde3eb7db121149d60d31beaf593e30e97
    spec.md: f0a55b6e3829b921680b1aa5f79fec0a56c69939f294af96620b356e26ff1b4c
    tasks.md: 14b0252dbdcb3357cde8e3501e30b9aa594335c1e7dedf271bbf1fd015dbdaf9
  blocking: false
---
...
This spec closes that gap: a backend observability rule set citable by ID (`BE-{CATEGORY}-{NNN}`) that `/ductus:analyze` checks against specs and plans (design-time observability commitments) and `/ductus:review` references where applicable.
...
- [x] AC4: The rule set covers, at minimum, metrics, distributed tracing, and health endpoints — each with a Verification clause expressed as a **design-time commitment** the spec/plan must make (not a code-pattern grep), consistent with how `/ductus:analyze` audits artifacts.
