...
next-criterion: 15
analyze:
  last-run: 2026-09-14T12:41:18Z
  analyzed-against: ec2b566d2ae566af4dddaac2bf2d191c705c4849
  hard-fail: 0
  blocking-findings: 0
  advisory: 0
  unexamined: 1
  analyzed-digest:
    data-model.md: 6fd2f2ac88690e649f39d60fba2c936f844b6699d2eade755547cd966bed7393
    plan.md: 3bcf6d4377aa0117a3fdb26d92483d7736c88df5cbde8e0ae24fffe1fb42b0cb
    review.md: fe9cf5cf67fd368fde6fe4b71b55c98cdd424eb5adc3ca16b36a53a1d675adb4
    spec.md: 09cf480a3b4aebf782e2711899c323973cf0fd17b108c893eece1f83744d4294
    tasks.md: 48a154bbd74cb7e157e2302c1111714ba73e84aa6bf658dc31a99d57cb3aadd9
...
- [x] AC11: The reduction is produced and written by the deterministic runtime prune primitive, with the file body never round-tripped through agent context; the markdown-only fallback reaches identical bytes, except on a `--reset` in a project that has customized its own `specs/templates/tasks.md`, where the runtime writes the framework body compiled into the primitive and the markdown-only host reads that project's copy.
