...
The obvious owner is the migration registry — `framework/bootstrap/ductus.md` §Pre-run Migrations is literally "adopter-side cleanup for conventions removed since the adopter's last `/ductus` run." It does not work here, for two independent reasons:
